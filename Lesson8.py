...
o_Vasya = Human()
o_Vasya.set_age(25)
o_Vasya.set_name('Vasya')
o_Vasya.set_location('Kirov')
# -----
o_Petya = Human()
o_Petya.set_age(27)
o_Petya.set_name('Petya')
o_Petya.set_location('Ufa')
print('-----')
o_Roma = Human()
o_Roma.set_name('Roma')
print('-----')
o_Rota1 = Rota()
o_Rota1.add_human([o_Vasya, o_Petya])
o_Rota1.info()
o_Rota1.set_location('Iran')
o_Rota1.rm_human([o_Roma, o_Petya])
o_Rota1.info()
o_Vasya.info()
print('-----')
o_Rota2 = Rota()
o_Rota2.add_human([o_Roma, o_Petya])
o_Rota2.info()
print('-----')
o_Polk1 = Polk()
o_Polk1.set_location('Siberia')
o_Polk1.info()
o_Polk1.add_rota([o_Rota1, o_Rota2])
o_Polk1.info()
o_Polk1.rm_rota([o_Rota1])
o_Polk1.info()
print('-----')
o_Rota2.rm_human([o_Roma])
o_Polk1.info()
print('-----')
o_Polk1.rota_100_info()